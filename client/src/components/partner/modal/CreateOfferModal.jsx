          ...
          <div className="relative z-10 flex items-center gap-5">
            ...
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-7 text-white/80">
                Launch conversion-focused
                offers, discounts, and
                customer campaigns directly
                from your restaurant panel.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-[2rem] border border-orange-100 bg-orange-50 p-6">
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-[1.2rem] bg-white text-orange-500 shadow-sm">
                    <Flame size={24} />
                  </div>
